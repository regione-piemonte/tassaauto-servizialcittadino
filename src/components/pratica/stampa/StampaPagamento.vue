  ...
  <div class="app-container">
    ...
    <div class="app-row inner-cont-bollo">
      <div class="col-12 col-lg-8 offset-lg-2">
              ...
              <v-list
                ...
                <v-list-item-group
                  ...
                  <v-list-item
                    ...
                    :inactive="true"
                    :ripple="false">
                    Scadenza: <strong>{{ pSintesiPagamento.scadenza }}</strong>
                  </v-list-item>
                  <v-list-item
                    id=""
                    :inactive="true"
                    :ripple="false">
                    Validità: <strong>{{ pSintesiPagamento.validita }} mesi</strong>
                  </v-list-item>
                  <v-list-item
                    id=""
                    :inactive="true"
                    :ripple="false">
                    Costo del bollo: <strong>{{ pSintesiPagamento.costoBollo | formatCurrency }}</strong>
                  </v-list-item>
                  <v-list-item
                    id=""
                    :inactive="true"
                    :ripple="false">
                    Sanzione: <strong v-if="pSintesiPagamento.sanzione > 0">{{ pSintesiPagamento.sanzione | formatCurrency }}</strong><strong v-else>non dovuta</strong>
                  </v-list-item>
                  <v-list-item
                    id=""
                    :inactive="true"
                    :ripple="false">
                    Interessi: <strong v-if="pSintesiPagamento.interessi > 0">{{ pSintesiPagamento.interessi | formatCurrency }}</strong><strong v-else>non dovuti</strong>
                  </v-list-item>
                  <v-list-item
                    id=""
                    :inactive="true"
        ...
        <div class="action-button-wide" id="action-buttons">
          <div class="col-md-6">
            <BtnBack
...
import { STAMPA_AVV_ACCERTAMENTO_PDF, STAMPA_AVV_SCADENZA_PDF } from '@/store/actions.type'
