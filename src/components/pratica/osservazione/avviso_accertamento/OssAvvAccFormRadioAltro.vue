        ...
        <div class="row">
          <div class="col-12">
            ...
            <v-textarea
              ...
              type="text"
              v-model="grigliaAccertamentoAltro.grigliaDirittoRiduzione.testo"
            ...
            <v-radio
              ...
              <template v-slot:label>
                <dati-tecnici-rettifica-form
                  ref="datiTecn"
                  :pDatiTecnici="grigliaAccertamentoAltro.grigliaDatiTecniciErrati"
...
export default {
  ...
  methods: {
    updMotivOssAltroMotivo () {
      ...
      this.grigliaAccertamentoAltro.grigliaDirittoRiduzione.value = (radioValue === 'dirittoRiduzione')
      this.grigliaAccertamentoAltro.grigliaDatiTecniciErrati.value = (radioValue === 'datiVeicoloRettifica')
      if (radioValue === 'datiVeicoloRettifica') {
        this.grigliaAccertamentoAltro.grigliaDatiTecniciErrati = this.$refs.datiTecn.getDatiTecniciRettificati()
      }
      store.dispatch(OSS_AVV_ACC_SALVA_GRIGLIA_ALTRO, this.grigliaAccertamentoAltro)
    }
  },
  async created () {
    store
    ...
    this.ossAvvAccForm.osservazRadio = await OsservazioneService.motivoOssAvvAccAltroMotivo(this.grigliaAccertamentoAltro)
  }
}
</script>
