  ...
  <div>
    <div class="space-section">
      ...
      <div
        ...
        {{ $t('pratica.osservazione.avviso_accertamento.motivazione.pagamentoAltraRegioneProvincia') }}
      </div>
      <div
        id="scadenzaErrata"
        ...
        <v-list
          ...
          <v-list-item-group
            ...
            <v-list-item
              ...
              Numero di Quietanza: {{ grigliaAccPagato.numeroQuietanza }}
            </v-list-item>
            <v-list-item
              id=""
              :inactive="true"
              ...
              Data del Pagamento: {{ new Date(grigliaAccPagato.dataPagamento) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
            <v-list-item
              id=""
              :inactive="true"
        ...
        <v-list
          ...
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              {{ $t('pratica.osservazione.avviso_accertamento.motivazione.venduto') }} {{ new Date(grigliaAccNonPagato.grigliaVenditaVeicolo.data) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
            <v-list-item
              id=""
              :inactive="true"
              ...
              {{ $t('pratica.osservazione.avviso_accertamento.motivazione.venduto_concessionario') }}
            </v-list-item>
          </v-list-item-group>
        </v-list>
      </div>
      <div
        id="radiatoDemolizione"
        v-if="osservazRadio == 'radiatoDemolizione'">
        <v-list
          class="text-uppercase"
          flat>
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              {{ $t('pratica.osservazione.avviso_accertamento.motivazione.radiato_demolizione') }} {{ new Date(grigliaAccNonPagato.grigliaRadiatoDemolizione.data) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
          </v-list-item-group>
        </v-list>
      </div>
        ...
        <v-list
          ...
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              {{ $t('pratica.osservazione.avviso_accertamento.motivazione.esportato') }} {{ new Date(grigliaAccNonPagato.grigliaRadiatoEsportazione.data) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
          </v-list-item-group>
        </v-list>
      </div>
        ...
        <v-list
          ...
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              Numero protocollo provvedimento: {{ grigliaAccNonPagato.grigliaEsenzioni.grigliaEsenzioniDisabili.numeroProtocolloProvvedimento }}
            </v-list-item>
            <v-list-item
              id=""
              :inactive="true"
              :ripple="false">
              Data: {{ new Date(grigliaAccNonPagato.grigliaEsenzioni.grigliaEsenzioniDisabili.data) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
          </v-list-item-group>
        </v-list>
      </div>
      <div
        ...
        <strong>
          {{ $t('pratica.osservazione.avviso_accertamento.motivazione.motivo_generico') }}
        </strong>
        <v-list
          class="text-uppercase"
          flat>
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              Motivazione: {{ grigliaAccNonPagato.grigliaEsenzioni.grigliaEsenzioniAltroMotivo.testo }}
            </v-list-item>
          </v-list-item-group>
        </v-list>
      </div>
      <div
        id="nonDisponibile"
        v-if="osservazRadio == 'nonDisponibile'">
        <strong>
          {{ $t('pratica.osservazione.avviso_accertamento.motivazione.non_disponibile') }}
        </strong><br>
        {{ $t('pratica.osservazione.avviso_accertamento.motivazione.non_disponibile_desc') }}<br>
        <v-list
          class="text-uppercase"
          flat>
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              Dal {{ new Date(grigliaAccNonPagato.grigliaPrivazioneDisponibilita.dataDal) | dateFormat('DD/MM/YYYY') }} Al {{ new Date(grigliaAccNonPagato.grigliaPrivazioneDisponibilita.dataAl) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
            <v-list-item
              id=""
              :inactive="true"
      ...
      <div
        id="maiPosseduto"
        v-if="osservazRadio == 'maiPosseduto'">
        <strong>
      ...
      <div
        id="trasferitoRegione"
        v-if="osservazRadio == 'trasferitoRegione'">
        <strong>
          {{ $t('pratica.osservazione.avviso_accertamento.motivazione.trasferito_regione') }}
        </strong>
        {{ new Date(grigliaAccNonPagato.grigliaTrasferimentoRegione.data) | dateFormat('DD/MM/YYYY') }}
      </div>
      <div
        id="esentatoImpianto"
        ...
        <v-list
          ...
          <v-list-item-group
            ...
            <v-list-item
              ...
              :inactive="true"
              :ripple="false">
              {{ $t('pratica.osservazione.avviso_accertamento.motivazione.esentato_impianto') }} {{ new Date(grigliaAccNonPagato.grigliaEsenzioni.grigliaInstallazioneGplMetano.data) | dateFormat('DD/MM/YYYY') }}
            </v-list-item>
          </v-list-item-group>
        </v-list>
      </div>
      ...
      <div
        id="dirittoRiduzione"
        v-if="osservazRadio == 'dirittoRiduzione'">
        <strong>
          {{ $t('pratica.osservazione.avviso_accertamento.motivazione.diritto_riduzione') }}
        </strong>
