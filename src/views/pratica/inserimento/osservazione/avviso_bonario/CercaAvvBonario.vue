          ...
          <div class="cerca-avviso col-lg-3 col-md-6 offset-lg-2 mt-8 mt-sm-0">
            ...
            <div class="text-inner pt-7 pl-0 pr-md-8 pr-lg-0">
              <p>
                ...
                <v-dialog v-model="dialog" max-width="600" class="dialog-popup">
                  ...
                  <v-card aria-hidden="true">
                    ...
                    <v-img
                      width="871"
                      :src="
                        require(`@/assets/images/ritagli/${regione}/modal-num_protocollo_avviso_bonario.jpg`)
                      "
                ...
                <span class="d-sr-only">avviso bonario</span> che hai
                ricevuto.
              </p>
              <!-- <router-link
                :to="{
              ...
              <div class="text-inner pt-3 pl-0 pr-md-8 pr-lg-0">
                <a href="https://www.regione.piemonte.it/web/temi/tributi/tassa-automobilistica-bollo-auto/tassa-automobilistica-avviso-bonario" target="_blank"><strong>Maggiori informazioni</strong></a>
              </div>
            </div>
          </div>
          <div class="form-cerca-avviso-hp col-lg-4 col-md-6 offset-lg-1">
            <h2>Cerca Avviso Bonario</h2>
...
export default {
  ...
  async created () {
    if (this.logged) {
      await store
        .dispatch(OSS_AVV_BONARIO_LIST_AUTENTICATI, this.userIdentity.cf)
        .catch((error) => {
    ...
    this.descrizione = '<p>Hai ricevuto un avviso <strong>bonario</strong> del bollo auto ' +
