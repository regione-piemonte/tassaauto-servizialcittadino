...
import { OSS_AVV_SCADENZA_CARICA_ALLEGATO, OSS_AVV_SCADENZA_ELIMINA_ALLEGATO } from '@/store/actions.type'
...
export default {
  ...
  methods: {
    aggiungiMotivazione () {
      ...
      if (this.$refs.formRadio.$v.ossAvvScadForm.$invalid) return
