          ...
          <div class="col-12 col-lg-8 offset-lg-2">
            <div class="risultati-ricerca">
              ...
              <div class="box-grigio mb-10 p-md-9" id="box-protocollo">
                ...
                <strong>Tipo di pratica</strong>: osservazione su domanda
                discarico.<br />
              </div>
              <DatiAnagraficiIntestatario
                ...
                :dataNascita="
                  esitoVerificaPratica.dataAnagraficiIntestatario.dataNascita
                "
                :comuneNascita="
                  esitoVerificaPratica.dataAnagraficiIntestatario.comuneNascita
                "
                :provinciaNascita="
                  esitoVerificaPratica.dataAnagraficiIntestatario
                    .provinciaNascita
                "
                :personaFisica="
                  esitoVerificaPratica.dataAnagraficiIntestatario
              ...
              <div
                class="space-section"
                v-if="
                  esitoVerificaPratica.dataAnagraficiRappresentante !== null
                "
              >
                <DatiAnagRapprLegale
                  :denominazione="
                    esitoVerificaPratica.dataAnagraficiRappresentante.nome +
                    ' ' +
                    esitoVerificaPratica.dataAnagraficiRappresentante.cognome
                  "
                  :codiceFiscale="
                    esitoVerificaPratica.dataAnagraficiRappresentante
                      .codiceFiscale
                  "
                  :sesso="
                    esitoVerificaPratica.dataAnagraficiRappresentante.sesso
                  "
                  :dataDiNascita="
                    esitoVerificaPratica.dataAnagraficiRappresentante
                      .dataNascita
              ...
              <TitoloEsecutivo
                ...
                :numeroEsecutivo="
                  esitoVerificaPratica.ingiunzioneFiscale !== null
                    ? esitoVerificaPratica.ingiunzioneFiscale.numeroIngiunzione
                    : esitoVerificaPratica.cartellaEsattoriale
              ...
              />
              <oggetto-domanda :oggetto="esitoVerificaPratica.oggettoDomanda" />
              <motivo-domanda :motivo="esitoVerificaPratica.motivo" />
              <Allegati
                :codiceFiscale="
                  esitoVerificaPratica.dataAnagraficiIntestatario.codiceFiscale
                "
              ...
              <div class="action-button-wide row">
                <div class="col-md-6">
                  <BtnBack :backUrl="'cerca_pratica'" :backType="'back'" />
